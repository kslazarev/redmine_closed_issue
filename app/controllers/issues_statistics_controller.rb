...
class IssuesStatisticsController < ApplicationController
  unloadable
  menu_item :statistics, :only => [:index]
  ...
  def index
    ...
    if @query.valid?
      ...
      respond_to do |format|
        format.html { render :template => 'issues_statistics/index', :layout => !request.xhr? }
        format.api {
